          ...
          const SectionCard(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 14),
                RainbowParagraph(
                    '''Located in Leytonstone, just minutes from Stratford and the heart of East London, the studio is easy to reach by tube, bus and car.
Ana Maria Studio & Academy is a Hair Salon in Leytonstone London E11, and a rare salon plus academy space in one, so every service comes with an educator’s mindset: technique, hair health and longevity come first.
